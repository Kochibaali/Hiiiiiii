...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
       ...
       text=(
        ...
        await query.answer(f"കിട്ടോ.. ഉണ്ടോ.. തരുമോ.അയക്കാമോ. sent. ലിങ്ക്.. Plz. Movie... എന്നിങ്ങനെ ഉള്ള വാക്കുകൾ ഒഴിവാക്കുക. മൂവിയുടെ പേര് സ്പെല്ലിങ് മിസ്റ്റേക്ക് ഇല്ല എന്നു ഉറപ്പ് വരുത്തിയതിന് ശേഷം മാത്രം ഗ്രൂപ്പിൽ ഇടുക. വേറേ ഒന്നും കൂട്ടി എഴുതരുത്.🔎",show_alert=True)
