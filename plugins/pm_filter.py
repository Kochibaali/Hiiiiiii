...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
       ...
       text=(
        ...
        await query.answer(f"കിട്ടോ.. ഉണ്ടോ.. തരുമോ.. Movie അയക്കാമോ.. Send ചെയ്യാമോ.. ലിങ്ക്.. ഫയൽ താ .... Plz... Movie... എന്നിങ്ങനെ ഉള്ള വാക്കുകൾ ബോട്ടിന് മനസ്സിലാകില്ല. അത് കൊണ്ട് മൂവി യുടെ പേര് സ്പെല്ലിങ് മിസ്റ്റേക്ക് ഇല്ല എന്നു ഉറപ്പ് വരുത്തിയതിന് ശേഷം മാത്രം ഗ്രൂപ്പിൽ ഇടുക. റിസൾട്ട് വരുന്നില്ലെങ്കിൽ മൂവിയുടെ പേരും മൂവി ഇറങ്ങിയ വർഷവും കൂടി ഇടുക. വേറെ ഒന്നും കൂട്ടി എഴുതരുത്.🔎",show_alert=True)
...
async def advantage_spell_chok(client, msg):
    ...
    btn.append([InlineKeyboardButton(text="Close", callback_data=f'endio#{reqstr1}#close_spellcheck')])
