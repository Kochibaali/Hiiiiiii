...
<i>𝖨𝖺𝗆 𝖯𝗈𝗐𝖾𝗋𝖥𝗎𝗅𝗅 𝖠𝗎𝗍𝗈 𝖥𝗂𝗅𝗍𝖾𝗋 + 𝖬𝗈𝗏𝗂𝖾 𝖲𝖾𝖺𝗋𝖼𝗁 + 𝖬𝖺𝗇𝗎𝖺𝗅 𝖥𝗂𝗅𝗍𝖾𝗋 𝖡𝗈𝗍 ⚙

𝖨𝖺𝗆 𝖠 𝖡𝗈𝗍 𝖯𝗋𝗈𝗏𝗂𝖽𝗂𝗇𝗀 𝖬𝗈𝗏𝗂𝖾𝗌 𝖠𝗇𝖽 𝖲𝖾𝗋𝗂𝖾𝗌 𝖲𝗈 𝖠𝖽𝖽 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖥𝖺𝗆. 𝖳𝗁𝖾𝗇 𝖨 𝖶𝗂𝗅𝗅 𝗌𝖾𝗇𝗍 𝖳𝗁𝖾 𝖬𝗈𝗏𝗂𝖾𝗌⏳</i>

ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ᴜsᴇғᴜʟ ʙᴜᴛᴛᴏɴs⛳️"""
...
"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
<b>- 𝖮𝗉𝖾𝗇 𝖲𝗈𝗎𝗋𝖼𝖾 𝖯𝗋𝗈𝗃𝖾𝖼𝗍. 
- 𝖲𝗈𝗎𝖼𝖾 - 𝖢𝗅𝗂𝖼𝗄 𝖡𝖾𝗅𝗈𝗐 𝖲𝗈𝗎𝗋𝖼𝖾 𝖡𝗎𝗍𝗍𝗈𝗇</b>"""
...
• /deletefiles - <code>Delete CamRip and PreDvD files delete from database </code>"""
    ...
    STATUS_TXT = """<b>★ Files: <code>{}</code>
★ Users: <code>{}</code>
★ Chats: <code>{}</code>
★ Used: <code>{}</code> 𝙼𝚒𝙱
★ Free: <code>{}</code> 𝙼𝚒𝙱</b>"""
